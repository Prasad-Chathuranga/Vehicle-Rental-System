...
%><br>
<h2 align="center"><font><strong>All Order Details</strong></font></h2><br>
...
<a style="text-decoration: none; margin-left: 50px;"  href="Admin_Portal.html"><button type="submit" class="btn btn-outline-danger">Back to Portal</button></a>
<!--      <br>
      <div class="col-sm-offset-2 col-sm-5" >
                            
                            
                            <a style="text-decoration: none; margin-left: 50px;"  href="admin_portal.html"><button type="submit" class="btn btn-block btn-outline-danger">Back to Portal</button></a>
                        </div>-->
