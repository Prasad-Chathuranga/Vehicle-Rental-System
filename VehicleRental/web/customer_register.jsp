                    ...
                    <div class="col-lg-4 col-md-8 m-auto">
                        <div class="login-page-content">
                            <div class="login-form"><br>
                                <h3 class="align text-light">User Registration</h3><hr class="bg-light">
                                <form action="registerUser" method="post">
                                    <div class="form-group">
                                        <label for="exampleInputEmail1" class="text-light">First Name</label>
                                        <input type="text" class="form-control" id="first_name" name="first_name" placeholder="Enter First Name">
                                    </div>
                                    <div class="form-group">
                                        <label for="exampleInputEmail1" class="text-light">Last Name</label>
                                    ...
                                    <div class="form-group">
                                        <label for="exampleInputPassword1" class="text-light">Re-Enter Password</label>
                                    ...
                                    <hr class="bg-light">
                                    <div>
                                        <button type="submit" name="sign_up" id="sign_up" value="sign_up" class="btn btn-block btn-primary">Sign Up</button>
                                        <!--<hr class="bg-light">-->
                                    </div>
                                </form>
                            </div>
